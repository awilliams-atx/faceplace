...
andrewglo File.open("#{Rails.root}/app/assets/images/andrew_williams_cover_photo.jpg")
andrew.save!
...
jeffreyglo File.open("#{Rails.root}/app/assets/images/jeffrey_lebowski_cover_photo.jpg")
jeffrey.save!
...
walterglo File.open("#{Rails.root}/app/assets/images/walter_sobchak_cover_photo.jpg")
walter.save!
...
donnyglo File.open("#{Rails.root}/app/assets/images/donald_kerabatsos_cover_photo.jpg")
donny.save!
...
jeff_srglo File.open("#{Rails.root}/app/assets/images/jeffrey_lebowski_sr_cover_photo.jpg")
jeff_sr.save!
...
maudeglo File.open("#{Rails.root}/app/assets/images/maude_lebowski_cover_photo.jpg")
maude.save!
...
jesusglo File.open("#{Rails.root}/app/assets/images/jesus_quintana_cover_photo.jpg")
jesus.save!
...
brandtglo File.open("#{Rails.root}/app/assets/images/brandt_bjergsen_cover_photo.jpg")
brandt.save!
...
danielglo File.open("#{Rails.root}/app/assets/images/daniel_teague_cover_photo.png")
daniel.save!
...
ulyssesglo File.open("#{Rails.root}/app/assets/images/ulysses_everett_mcgill_cover_photo.jpg")
ulysses.save!
...
peteglo File.open("#{Rails.root}/app/assets/images/pete_hogwallop_cover_photo.png")
pete.save!
...
delmarglo File.open("#{Rails.root}/app/assets/images/delmar_odonnell_cover_photo.jpg")
delmar.save!
...
tommyglo File.open("#{Rails.root}/app/assets/images/tommy_johnson_cover_photo.png")
tommy.save!
...
pappyglo File.open("#{Rails.root}/app/assets/images/pappy_odaniel_cover_photo.jpg")
pappy.save!
...
post = Post.new
post.author = andrew
post.body = 'Thanks for stopping by Faceplace! Why not check out some of these stellar individuals I have tagged below?'
post.save!
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'Couldn\'t agree more!'
comment.author_id = tommy.id
comment.save!

comment = Comment.new
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'Vote for me!'
comment.author_id = pappy.id
comment.save!

comment = Comment.new
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'I think politics are a perfectly barbaric pastime.'
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'Gorsh, I\'d be mighty pleased if you stopped by my perfile.'
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'Yea, Walter, calm down.'
comment.author_id = donny.id
comment.save!
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'You\'re way out of your element, Donny.'
comment.author_id = walter.id
comment.save!
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'I think bowling is a perfectly barbaric pastime.'
comment.author_id = maude.id
comment.save!
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'You don\'t scare me.'
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'I don\'t know how you get past those freaks in the league office.'
comment.author_id = jesus.id
comment.save!
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'I\'m gonna crush you.'
comment.author_id = jesus.id
comment.save!
...
comment.commentable_type = 'Post'
comment.commentable_id = post.id
comment.body = 'Would you two calm down?'
comment.author_id = maude.id
comment.save!
